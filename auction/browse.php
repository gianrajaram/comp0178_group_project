...
## outstanding task for browse: implement is active? toggle
...
<!-- will need hidden url feature -->

  <div class="col-md-2 pr-0">
        <div class="form-group">
          <label  for="active" class="sr-only">Active listing filter</label>
          <select class="form-control" id="active" name="active">
          <option value = "Show active listings only" >Active</option>
          <option value="active" <?php echo $activeListing === 'pricelow' ? 'selected' : '' ?>>Show active listings only </option>
          </select>
        </div>
      </div>
      <div class="col-md-1 px-0">

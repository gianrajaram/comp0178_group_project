...
if(isset($_SESSION['userID'])) {
    ...
    $sql_auction = "SELECT a.auctionID, a.sellerID, a.auctionName, 
                        a.auctionReservePrice, a.categoryType, a.categoryColor, 
                        a.categoryGender, a.categorySize, u.username, a.auctionDescription,
                        a.auctionStartDate, a.auctionEndDate, a.auctionPicture, a.auctionStartingPrice, 
                        MAX(b.bidValue) as auctionMaxCP, 
                        MAX(b1.bidValue) AS maxBuyerBidValue, 
                        COUNT(b.auctionID) as auctionBidCount
                    FROM Auctions a
                    ...
                    GROUP BY a.auctionID, a.sellerID, a.auctionName, a.auctionReservePrice, 
                    a.categoryType, a.categoryColor, a.categoryGender, 
                    a.categorySize, u.username, a.auctionDescription, a.auctionStartDate, 
                    a.auctionEndDate, a.auctionStartingPrice";
} else {
    $sql_auction = "SELECT a.auctionID, a.sellerID, a.auctionName, 
                    a.auctionReservePrice, a.categoryType, a.categoryColor, 
                    a.categoryGender, a.categorySize, u.username, a.auctionDescription,
